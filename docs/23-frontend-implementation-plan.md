...
| ~~หน้า `/change-password`~~ | ~~ยกเลิกแล้ว~~ — หน้า `/change-password` ถูกถอดออกตามที่องค์กรสั่ง (2026-09-09) ไม่มีการบังคับเปลี่ยนรหัสอีกต่อไป |
...
| **E5** | ~~**บังคับเปลี่ยนรหัสผ่านครั้งแรก + บัญชีถูกล็อก**~~ | — | ~~ยกเลิกแล้ว~~ — หน้า `/change-password` ถูกถอดออกตามที่องค์กรสั่ง (2026-09-09) ไม่มีการบังคับเปลี่ยนรหัสอีกต่อไป และการล็อกบัญชีก็ถูกยกเลิกเช่นกัน — ไม่มีอะไรให้ทดสอบในข้อนี้แล้ว |
