...
export const CHECKLIST_TEMPLATES: ChecklistTemplate[] = [
  {
    ...
    is_active: true,
    items: [
      { id: 1, sort_order: 10, title_th: 'ສ້າງບັນຊີຜູ້ໃຊ້ ແລະ ອີເມວ', is_required: true, evidence_required: false, default_role_code: 'support_agent' },
      { id: 2, sort_order: 20, title_th: 'ມອບສິດເຂົ້າເຖິງລະບົບຕາມໜ້າທີ່', is_required: true, evidence_required: true, default_role_code: 'support_agent' },
      { id: 3, sort_order: 30, title_th: 'ຕຽມເຄື່ອງຄອມພິວເຕີ ແລະ ຕິດຕັ້ງຊອບແວມາດຕະຖານ', is_required: true, evidence_required: false, default_role_code: 'support_agent' },
      { id: 4, sort_order: 40, title_th: 'ຕິດຕັ້ງໂປຣແກຣມປ້ອງກັນໄວຣັສ', is_required: true, evidence_required: false, default_role_code: 'support_agent' },
      { id: 5, sort_order: 50, title_th: 'ບັນທຶກອຸປະກອນເຂົ້າທະບຽນຊັບສິນ', is_required: true, evidence_required: true, default_role_code: 'support_agent' },
      { id: 6, sort_order: 60, title_th: 'ຊີ້ແຈງນະໂຍບາຍຄວາມປອດໄພ ແລະ ໃຫ້ເຊັນຮັບຮູ້', is_required: true, evidence_required: true, default_role_code: 'support_agent' },
      { id: 7, sort_order: 70, title_th: 'ບັງຄັບປ່ຽນລະຫັດຜ່ານເມື່ອເຂົ້າໃຊ້ຄັ້ງທຳອິດ', is_required: true, evidence_required: false, default_role_code: 'support_agent' },
    ],
  },
  {
    id: 2,
    ...
    is_active: true,
    items: [
      { id: 8, sort_order: 10, title_th: 'ປິດການໃຊ້ງານບັນຊີຜູ້ໃຊ້ທັນທີໃນວັນສຸດທ້າຍ', is_required: true, evidence_required: true, default_role_code: 'support_agent' },
      { id: 9, sort_order: 20, title_th: 'ຖອນສິດເຂົ້າເຖິງທຸກລະບົບ', is_required: true, evidence_required: true, default_role_code: 'support_agent' },
      { id: 10, sort_order: 30, title_th: 'ຮັບຄືນອຸປະກອນ ແລະ ບັນທຶກສະພາບ', is_required: true, evidence_required: true, default_role_code: 'support_agent' },
      { id: 11, sort_order: 40, title_th: 'ໂອນຂໍ້ມູນ ແລະ ໄຟລ໌ວຽກໃຫ້ຫົວໜ້າ', is_required: true, evidence_required: false, default_role_code: 'support_agent' },
      { id: 12, sort_order: 50, title_th: 'ຕັ້ງການສົ່ງຕໍ່ອີເມວຕາມທີ່ຫົວໜ້າກຳນົດ', is_required: false, evidence_required: false, default_role_code: 'support_agent' },
      { id: 13, sort_order: 60, title_th: 'ລຶບບັນຊີອອກຈາກກຸ່ມ ແລະ ລາຍຊື່ສົ່ງອີເມວ', is_required: true, evidence_required: false, default_role_code: 'support_agent' },
