...
export const TICKETS: TicketListItem[] = [
  {
    ...
    assignee: null,
    sla: { response_due_at: at(-30), workaround_at: null, is_response_breached: true, first_response_at: null, status: 'breached', remaining_minutes: -72, remaining_unit: 'calendar_minutes', resolution_due_at: at(-72), is_resolution_breached: true },
    reopen_count: 0,
    comment_count: 1,
    attachment_count: 0,
    closed_at: null,
  ...
  },
  {
    ...
    sla: { response_due_at: at(-30), workaround_at: null, is_response_breached: false, first_response_at: null, status: 'at_risk', remaining_minutes: 42, remaining_unit: 'business_minutes', resolution_due_at: at(42), is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 3,
    attachment_count: 2,
    closed_at: null,
  ...
  },
  {
    ...
    sla: { response_due_at: at(-30), workaround_at: null, is_response_breached: false, first_response_at: null, status: 'on_track', remaining_minutes: 310, remaining_unit: 'business_minutes', resolution_due_at: at(DAY + 120), is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 2,
    attachment_count: 1,
    closed_at: null,
  ...
  },
  {
    ...
    sla: { response_due_at: at(-30), workaround_at: null, is_response_breached: false, first_response_at: null, status: 'paused', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: '', is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 4,
    attachment_count: 1,
    closed_at: null,
  ...
  },
  {
    ...
    assignee: { id: 90, full_name: 'ທະນູ ວັດທະນາ' },
    sla: { response_due_at: at(-30), workaround_at: null, is_response_breached: false, first_response_at: null, status: 'on_track', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: at(-2 * DAY), is_resolution_breached: false },
    reopen_count: 1,
    comment_count: 8,
    attachment_count: 0,
    closed_at: null,
  ...
  },
  {
    ...
    assignee: null,
    sla: { response_due_at: at(-30), workaround_at: null, is_response_breached: false, first_response_at: null, status: 'on_track', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: '', is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 1,
    attachment_count: 0,
    closed_at: null,
  ...
  },
  {
    ...
    assignee: { id: 91, full_name: 'ສົມຍິງ ຈັນທະວົງ' },
    sla: { response_due_at: at(-30), workaround_at: null, is_response_breached: false, first_response_at: null, status: 'on_track', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: at(-6 * DAY), is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 5,
    attachment_count: 3,
    closed_at: null,
...
export function ticketDetail(id: number): TicketDetail | null {
  ...
  return {
    ...
    /* response_due_at กับ workaround_at ย้ายไปอยู่ใน sla แล้ว ตามที่ API ส่งจริง */
    ...
    history: [
      { id: 8001, changed_by: base.requester, from_status: null, to_status: 'new', from_priority: null, to_priority: null, reason: null, changed_at: at(-4 * 60) },
      { id: 8002, changed_by: { id: 88, full_name: 'ພູວົງ ສີສຸກ' }, from_status: 'new', to_status: 'assigned', from_priority: null, to_priority: null, reason: null, changed_at: at(-3 * 60 - 5) },
      { id: 8003, changed_by: { id: 88, full_name: 'ພູວົງ ສີສຸກ' }, from_status: 'assigned', to_status: 'in_progress', from_priority: 'P2', to_priority: 'P1', reason: 'ກະທົບການຮັບ-ຈ່າຍສິນຄ້າທັງຄັງ ບໍ່ມີທາງລ່ຽງ', changed_at: at(-3 * 60) },
    ],
