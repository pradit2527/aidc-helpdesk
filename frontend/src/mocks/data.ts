...
export const TICKETS: TicketListItem[] = [
  {
    ...
    assignee: null,
    sla: { first_response_at: null, status: 'breached', remaining_minutes: -72, remaining_unit: 'calendar_minutes', resolution_due_at: at(-72), is_resolution_breached: true },
    reopen_count: 0,
    comment_count: 1,
    attachment_count: 0,
    updated_at: at(-3),
  },
  {
    ...
    sla: { first_response_at: null, status: 'at_risk', remaining_minutes: 42, remaining_unit: 'business_minutes', resolution_due_at: at(42), is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 3,
    attachment_count: 2,
    updated_at: at(-88),
  },
  {
    ...
    sla: { first_response_at: null, status: 'on_track', remaining_minutes: 310, remaining_unit: 'business_minutes', resolution_due_at: at(DAY + 120), is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 2,
    attachment_count: 1,
    updated_at: at(-DAY),
  },
  {
    ...
    sla: { first_response_at: null, status: 'paused', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: '', is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 4,
    attachment_count: 1,
    updated_at: at(-2 * DAY),
  },
  {
    ...
    assignee: { id: 88, full_name: 'ພູວົງ ສີສຸກ' },
    sla: { first_response_at: null, status: 'paused', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: at(3 * DAY), is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 6,
    attachment_count: 2,
    updated_at: at(-3 * DAY),
  },
  {
    ...
    assignee: { id: 90, full_name: 'ທະນູ ວັດທະນາ' },
    sla: { first_response_at: null, status: 'on_track', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: at(-2 * DAY), is_resolution_breached: false },
    reopen_count: 1,
    comment_count: 8,
    attachment_count: 0,
    updated_at: at(-4 * DAY),
  },
  {
    ...
    assignee: null,
    sla: { first_response_at: null, status: 'on_track', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: '', is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 1,
    attachment_count: 0,
    updated_at: at(-5 * DAY),
  },
  {
    ...
    assignee: { id: 91, full_name: 'ສົມຍິງ ຈັນທະວົງ' },
    sla: { first_response_at: null, status: 'on_track', remaining_minutes: null, remaining_unit: 'business_minutes', resolution_due_at: at(-6 * DAY), is_resolution_breached: false },
    reopen_count: 0,
    comment_count: 5,
    attachment_count: 3,
    updated_at: at(-7 * DAY),
