  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        //
        // ชั้นที่สามเป็นเงาฟุ้งกว้างที่จางมาก ทำให้การ์ดดูยกขึ้นจากพื้นชัดขึ้น
        // โดยที่ขอบยังคม ถ้าเพิ่มความเข้มของสองชั้นแรกแทน ขอบจะดูเลอะ
        card: '0 1px 2px rgb(15 23 42 / 0.06), 0 2px 6px -1px rgb(15 23 42 / 0.10), 0 10px 24px -14px rgb(15 23 42 / 0.18)',
